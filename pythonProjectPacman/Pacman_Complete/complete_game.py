...
#призраки, общий класс, создание и рендер
class Ghost(Entity):
...
#присоединение спрайтов к объектам
...
class Text(object):
    def __init__(self, text, color, x, y, size, time=None, id=None, visible=True):
        ...
        self.label = None
        self.destroy = False
        self.setupFont("PressStart2P-Regular.ttf")#файл со шрифтами
        self.createLabel()
